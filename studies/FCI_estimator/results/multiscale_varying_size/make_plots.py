...
plt.figure(figsize=(10, 6))
plt.plot(np.arange(10, 400), data_fixed['C']['estimates'], label='Dataset C')
plt.axhline(y=20, color='red', linestyle='--', linewidth=1, label=f'True ID')
...
plt.figure(figsize=(10, 6))
plt.plot(np.arange(10, 400), data_fixed['B']['estimates'], label='Dataset B')
